...
@Component({
  selector: 'app-so-datewise-report',
  templateUrl: './so-datewise-report.component.html',
  styleUrls: ['./so-datewise-report.component.scss']
})
export class SoDatewiseReportComponent implements OnInit {
  ...
  onSubmit() {
    ...
    if (this.reportForm.valid) {
      ...
      this.formService.getDatewiseExport(this.TypeData).subscribe((resp: any) => {
        this.ksLoader = true;
