...
@Component({
  selector: 'app-admin-detail-report',
  templateUrl: './admin-detail-report.component.html',
  styleUrls: ['./admin-detail-report.component.scss']
})
export class AdminDetailReportComponent implements OnInit {
  ...
  onSubmit(form: FormGroup) {
    ...
    if (form.valid) {
      this.formService.getAdminDetailReport(data).subscribe((resp: APIResponse) => {
        this.empty = false;
        this.ksLoader = true;
